      ...
      <header className="relative min-h-screen flex items-center pt-20 px-6 md:px-12 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            ...
            data-alt="Cinematic wide shot of the iconic blue and white architecture of Sidi Bou Said overlooking the turquoise Mediterranean Sea at sunrise."
            src="https://tunisiagotravel.com/blog/wp-content/uploads/2021/08/shopping-sidi.webp"
          />
        ...
        <div className="relative z-10 max-w-4xl">
          <h1 className="font-headline text-6xl md:text-8xl text-primary font-bold leading-tight mb-6">
            Unveil the Heart <br />
            <span className="italic text-tertiary">of Tunisia</span>
          </h1>
          <p className="text-xl md:text-2xl text-on-surface-variant max-w-2xl mb-10 leading-relaxed">
            Discover authentic local experiences and connect with the soul of
            the Mediterranean through our curated digital journey.
          </p>
      ...
      <section className="py-32 px-6 md:px-12 relative arabesque-pattern">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-20 items-center">
          ...
          <div className="w-full md:w-1/2 space-y-8">
            ...
            <h2 className="font-headline text-5xl text-primary font-bold leading-tight">
              A Bridge Between Worlds
            </h2>
            <p className="text-on-surface-variant text-lg leading-relaxed">
              Our geolocation-based platform doesn't just show you places; it
              introduces you to people. Using high-precision location mapping,
              we connect you with local "Curators"—citizens who open their homes
              and heritage to those seeking more than just a souvenir.
            </p>
            <ul className="space-y-4">
              <li className="flex items-start gap-4">
                <div className="p-2 bg-primary/10 rounded-xl text-primary">
                  <span
                    className="material-symbols-outlined max-w-fit"
                    data-weight="fill"
                  >
                    location_on
                  </span>
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant">
                    Find hidden gems within walking distance of your current
                    stay.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant">
                    Every experience directly supports the local economy and
      ...
      <section className="py-24 bg-surface-container-low px-6 md:px-12">
        <div className="max-w-7xl mx-auto mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-on-surface-variant text-xl mt-4 max-w-xl">
              Choose your path through the diverse tapestry of Tunisian life.
            </p>
          </div>
          <Link
            to="/explore"
          ...
          <div className="md:col-span-7 group relative rounded-3xl overflow-hidden shadow-lg transition-transform hover:scale-[1.01] cursor-pointer">
            <Link to="/explore?category=ARTISAN_WORKSHOP">
              ...
              <div className="absolute bottom-10 left-10 text-white">
                <span className="bg-tertiary text-[10px] uppercase font-bold tracking-widest px-3 py-1 rounded-full mb-3 inline-block">
                  Hands-on
                </span>
                ...
                <p className="text-white/80 mt-2 max-w-xs">
                  Master the ancient arts of weaving, pottery, and calligraphy.
                </p>
              </div>
            </Link>
          </div>
          <div className="md:col-span-5 group relative rounded-3xl overflow-hidden shadow-lg transition-transform hover:scale-[1.01] cursor-pointer">
            <Link to="/explore?category=ARTISAN_WORKSHOP">
              <img
                alt="Riad Courtyard"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                src="https://www.notesfromtheroad.com/files/sidi-bou-said-street.webp"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
              <div className="absolute bottom-10 left-10 text-white">
                ...
                <p className="text-white/80 mt-2">
                  Sleep within the walls of history.
                </p>
              </div>
            </Link>
          </div>
          <div className="md:col-span-5 group relative rounded-3xl overflow-hidden shadow-lg transition-transform hover:scale-[1.01] cursor-pointer">
            <Link to="/explore?category=GASTRONOMY">
              <img
                alt="Tunisian Spices"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAf3cEL_W_2KcjsRK-bRxvs9FgGHNRYxXEuyNOXVok5IUlnHpJ0lP7SqEmpwZC7szLFw1p2Whb3V9zCce2hmZX_fkg7maRLhK1uurHMA6TUCnhJ_lXo97EE_TclofQXCstFWqDGSH1wN5Lgb90zDXZhE6FND-AvMBDRrUjHqWlGjVIQY57iz3-EpHc2oetxJ89b5OplH-tqDgl0gcmtNKF2hsf4ldCeoKFV4sFhF9e7shy8NzF9c3HIxpaGMxEQ8Z-r-fMRXjoBL9A"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
              <div className="absolute bottom-10 left-10 text-white">
                <h3 className="text-3xl font-headline font-bold">
                ...
                <p className="text-white/80 mt-2">
                  Private kitchen experiences with family matriarchs.
                </p>
              </div>
            </Link>
          </div>
          <div className="md:col-span-7 group relative rounded-3xl overflow-hidden shadow-lg transition-transform hover:scale-[1.01] cursor-pointer">
            <Link to="/explore?category=DESERT_EXPEDITION">
              <img
                alt="Sahara Desert"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCwgf9Lh-j_Cval-WlNx-04AKpLwJpLuEsJ0MhsauFfZv0WJ1Y3EU59z239av_kWCOk30Jct9jEu60fvmXHU_5Bha5tUhW7lcqxHuY8CjbeSh-kW8YRrl46vgkkm2k6ixxWcq45xvpx2xr8FsAuKKBFVuEwQxzZXJcmoxgE6YYKJxOCKrHRNmagImZSar59lu9g90QE9fobBnn-yv_tPYOGO9VKNivzu9KaF0s0qizyPr7gQiUCUQ22h8DWRU-nmBoHJioEwa3AHjw"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
              <div className="absolute bottom-10 left-10 text-white">
                <h3 className="text-4xl font-headline font-bold">
                ...
                <p className="text-white/80 mt-2">
                  Navigate the golden silence of the Sahara.
                </p>
              </div>
            </Link>
          </div>
      ...
      <section className="py-32 px-6 md:px-12 bg-surface">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-16 items-center">
          <div className="lg:col-span-1">
            ...
            <h2 className="font-headline text-5xl text-primary font-bold mt-4 mb-6">
              Voices of the Medina
            </h2>
            <p className="text-on-surface-variant leading-relaxed mb-8">
              Our curators are historians, chefs, artists, and elders. They are
              the keepers of the Tunisian soul, ready to welcome you into their
              narrative.
            </p>
          ...
          <div className="lg:col-span-2 flex flex-col md:flex-row gap-8">
            <div className="flex-1 bg-surface-container-lowest p-8 rounded-[2rem] shadow-xl shadow-on-surface/5 relative overflow-hidden group">
              ...
              <img
                ...
                src="https://d34ad2g4hirisc.cloudfront.net/location_photos/files/000/250/391/main/3149c73ff81a33c8fd996614134643c0.jpg"
              />
              ...
              <p className="mt-4 text-on-surface-variant italic">
                "I don't just teach weaving; I teach the language of symbols
              ...
              <div className="mt-6 pt-6 border-t border-surface-container-high flex justify-between items-center">
                <span className="text-xs font-bold text-on-surface/40 uppercase">
                  Experience
                </span>
                <span className="text-sm font-bold text-primary">
                  Indigo & Silk Masterclass
                </span>
              </div>
            </div>
            <div className="flex-1 bg-surface-container-lowest p-8 rounded-[2rem] shadow-xl shadow-on-surface/5 relative overflow-hidden mt-12 md:mt-24 group">
              ...
              <img
                alt="Ahmed curator"
                className="w-24 h-24 rounded-full object-cover mb-6 border-4 border-white shadow-lg"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSstnpmqO_cKSZsBQzZZtxdiGJup2B-ieTHQ&s"
              />
              <h4 className="text-2xl font-headline font-bold text-primary">
                Ahmed M.
              </h4>
              ...
              <p className="mt-4 text-on-surface-variant italic">
                "The stars in the Sahara tell stories that haven't changed since
                the Berbers first named them."
              </p>
              <div className="mt-6 pt-6 border-t border-surface-container-high flex justify-between items-center">
                <span className="text-xs font-bold text-on-surface/40 uppercase">
                  Experience
      ...
      <section className="py-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto bg-gradient-to-br from-primary to-primary-container rounded-[3rem] p-12 md:p-24 relative overflow-hidden text-center">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="font-headline text-5xl md:text-6xl text-white font-bold mb-8 italic">
              Ready to curate your story?
            </h2>
            <p className="text-white/80 text-xl mb-12 leading-relaxed">
              Whether you're a traveler seeking the authentic or a citizen proud
              of your craft, your journey starts here.
            </p>
